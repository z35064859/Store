		...
		<c:if test="${not empty cart.cartItems }">
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a
						href="${pageContext.request.contextPath}/CartServlet?method=removeAllCartItemFromCart"
...
$(function () {
	$(".delete").click(function(){
		if(confirm("确认删除么？")){
			var pid=this.id;
			window.location.href="/store_v5/CartServlet?method=removeCartItemFromCart&id="+pid;
		}
	});
});
</script>
