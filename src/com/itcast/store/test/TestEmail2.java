...
public class TestEmail2 {
    ...
    public static String myEmailAccount = "aaa@store.com";
    public static String myEmailPassword = "aaa";
 
    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
    public static String myEmailSMTPHost = "loclhost";
 
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "bbb@store.com";
    ...
    public void createEmail(){
        ...
        // 1. 创建一封邮件
            ...
            // 3. To: 收件人
            message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("308140902@qq.com", "USER_CC", "UTF-8"));
            //    To: 增加收件人（可选）
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "火星情报局", "UTF-8"));
        ...
        message.setSubject("这是一封神奇的邮件！", "UTF-8");
 
        // 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
        message.setContent("尊敬的各位用户你好, 恭喜你们每人中了一毛钱，请拨打10086领取！", "text/html;charset=UTF-8");
